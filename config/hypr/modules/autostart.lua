...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd("sleep 60 && google-chrome-stable", { workspace = "1" })
	hl.exec_cmd("sleep 10 kitty && ghostty", { workspace = "2 silent" })
	hl.exec_cmd("sleep 30 && firefox", { workspace = "3 silent" })
