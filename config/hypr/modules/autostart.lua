...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd("sleep 10 ghostty", { workspace = "2 silent" })
	hl.exec_cmd("sleep 80 && firefox", { workspace = "3 silent" })
	hl.exec_cmd("sleep 20 && librewolf", { workspace = "4 silent" })
	hl.exec_cmd("sleep 120 && Telegram", { workspace = "4 silent" })
	hl.exec_cmd("sleep 200 && keepassxc", { workspace = "7 silent" })
